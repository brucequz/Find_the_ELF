...
TEST(DuoCodecTest, EncodeTest) {
  ...
  std::vector<MessageInformation> output_1 = codec_1.listViterbiDecoding(received_signal);
  std::vector<MessageInformation> output_2 = codec_2.listViterbiDecoding(received_signal_2);
