...
COMPILE_COMMAND="clang++ -g -o minheap_test minheap_test.cpp ../src/minHeap.cpp -I /usr/local/Cellar/googletest/1.14.0/include -lgtest -lgtest_main -pthread -std=c++14"
$COMPILE_COMMAND
